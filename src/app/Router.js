...
export default () => {
  ...
  window.onpopstate = (e) => {
    ...
    if (window.location.pathname === "/" && !user) {
      ...
      // Si l'utilisateur est actuellement sur le dashboard, l'empêcher de naviguer en arrière
      if (
        window.location.hash === ROUTES_PATH["dashboard"] ||
        ROUTES_PATH["bills"]
      ) {
        // Rester sur le dashboard - recharger la page actuelle
